...
import { coffeetalkPalettes } from "./palettes.js";
import { coffeetalkDefs } from "./defs.js";
...
export const coffeetalkStyle: AvatarStyle = {
  name: "coffeetalk",
  meta: {
    title: "Coffee Talk",
  ...
  render(options: AvatarOptions, colors: ResolvedColors): string {
    ...
    fragments.push(coffeetalkDefs(colors));

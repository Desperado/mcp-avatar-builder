...
import { tailsnoirPalettes } from "./palettes.js";
import { tailsnoirDefs } from "./defs.js";
import { variants as backgroundVariants } from "./parts/background.js";
import { variants as headVariants } from "./parts/head.js";
import { variants as earVariants } from "./parts/ears.js";
...
export const tailsnoirStyle: AvatarStyle = {
  name: "tailsnoir",
  meta: {
    title: "Tails Noir",
  ...
  categories: [
    ...
    { name: "ears", variants: Object.keys(earVariants), default: 0 },
    ...
    { name: "hair_back", variants: Object.keys(hairBackVariants), default: 0, optional: true },
    { name: "hair_front", variants: Object.keys(hairFrontVariants), default: 0, optional: true },
    { name: "face_mods", variants: Object.keys(faceModVariants), default: 0, optional: true },
  ...
  render(options: AvatarOptions, colors: ResolvedColors): string {
    ...
    fragments.push(tailsnoirDefs(colors));

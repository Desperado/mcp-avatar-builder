...
import { horrorPalettes } from "./palettes.js";
import { horrorDefs } from "./defs.js";
...
export const horrorStyle: AvatarStyle = {
  name: "horror",
  meta: {
    title: "Horror",
  ...
  render(options: AvatarOptions, colors: ResolvedColors): string {
    ...
    fragments.push(horrorDefs(colors));
